...
import com.example.ecommerce.databinding.CustomToastBinding
...
object UtilsFunctions {
    ...
    fun showToastWarning(message : String?) {
        ...
        val layout = inflater.inflate(com.example.ecommerce.R.layout.layout_toast, null)
    ...
    @JvmStatic
    fun loadImage(context: Context, url: String, reqOptions: RequestOptions, resourceId: Int, imageView: ImageView) {
        Glide.with(context)
            .load(url)
            .apply(reqOptions)
