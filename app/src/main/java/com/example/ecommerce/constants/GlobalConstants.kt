...
/*gNuXeqdFaUOsjP80Piwy8bEZ7t2xIxginKxqFDYPdyE=*/
    ...
    @JvmStatic
    val BASE_URL = "http://51.79.40.224:9074/api/"
    @JvmStatic
    val BASE_SERVER = "http://51.79.40.224:9074/"
    /* @JvmStatic
     val SOCKET_URL = "http://10.8.23.202:9062"*/
    @JvmStatic
    val SOCKET_URL = "http://51.79.40.224:9074/"
    ...
    var Currency = "Rs"
    @JvmStatic
    var CART_CATEGORY_TYPE = "Rs"
    @JvmStatic
    var COLOR_CODE = "#FFA42A"
