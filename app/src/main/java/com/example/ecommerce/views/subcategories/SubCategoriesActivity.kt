...
import com.example.ecommerce.databinding.ActivitySubCategoriesBinding
...
import com.example.ecommerce.viewmodels.subcategories.SubCategoriesViewModel
...
class SubCategoriesActivity : BaseActivity() {
    ...
    private var subCatsList = ArrayList<com.example.ecommerce.model.subcategories.Subcategories>()
    var catId = ""
    var isCart = ""
